...
namespace WFActivityLibrary1 {
    ...
    public partial class BugActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(BugActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(BugActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(BugActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".BugActivity.g.xaml") || resource.Equals("BugActivity.g.xaml"))) {
                    return resource;
                }
            }
